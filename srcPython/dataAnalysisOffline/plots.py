...
file_path = "docs/logs/logs_offlineAnalysis/offlineAnalysis_2024-07-04_16-51-56.txt"
file_path_semantics = (
    "docs/logs/logs_offlineAnalysis/offlineAnalysis_w_semantics2024-07-04_16-51-56.txt"
)
print(file_path)
