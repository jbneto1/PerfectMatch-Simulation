...
file_path = "docs/logs/logs_offlineAnalysis/offlineAnalysis_2024-05-09_17-01-36.txt"
file_path_semantics = (
    "docs/logs/logs_offlineAnalysis/offlineAnalysis_w_semantics2024-05-09_17-01-36.txt"
)
print(file_path)
